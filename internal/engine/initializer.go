...
func initProfessions() []model.Profession {
	return []model.Profession{
		{ID: 1, SiloID: 0, Name: "Mayor", ClassType: "ELITE", PowerLevel: 10, Zone: "Upper", Population: 1, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.95}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Mayor_1", "Mayor_2", "Mayor_3", "Mayor_4", "Mayor_5"}, Relations: map[string]float64{}},
		{ID: 2, SiloID: 0, Name: "Judicial", ClassType: "ELITE", PowerLevel: 9, Zone: "Upper", Population: 200, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.9}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Judicial_1", "Judicial_2", "Judicial_3", "Judicial_4", "Judicial_5"}, Relations: map[string]float64{}},
		{ID: 3, SiloID: 0, Name: "IT", ClassType: "ELITE", PowerLevel: 9, Zone: "Upper", Population: 150, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.85}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"IT_1", "IT_2", "IT_3", "IT_4", "IT_5"}, Relations: map[string]float64{}},
		{ID: 4, SiloID: 0, Name: "Police", ClassType: "ELITE", PowerLevel: 8, Zone: "Upper", Population: 250, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.9}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Police_1", "Police_2"}, Relations: map[string]float64{}},
		{ID: 5, SiloID: 0, Name: "Medical", ClassType: "ELITE", PowerLevel: 7, Zone: "Mid", Population: 400, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.75}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Medical_1", "Medical_2"}, Relations: map[string]float64{}},
		{ID: 6, SiloID: 0, Name: "Supply", ClassType: "COMMONER", PowerLevel: 6, Zone: "Mid", Population: 2500, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.65}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Supply_1", "Supply_2"}, Relations: map[string]float64{}},
		{ID: 7, SiloID: 0, Name: "Mechanical", ClassType: "COMMONER", PowerLevel: 8, Zone: "Lower", Population: 3000, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.6}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Mechanical_1", "Mechanical_2"}, Relations: map[string]float64{}},
		{ID: 8, SiloID: 0, Name: "Mines", ClassType: "COMMONER", PowerLevel: 4, Zone: "Lower", Population: 1000, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.55}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Mines_1", "Mines_2"}, Relations: map[string]float64{}},
		{ID: 9, SiloID: 0, Name: "Agricultural", ClassType: "COMMONER", PowerLevel: 6, Zone: "Mid", Population: 2499, Ideologies: map[string]float64{model.IdeologyProForeign: 0.05, model.IdeologyLoyalty: 0.7}, PanicValue: 0.0, Productivity: 1.0, KnownFragments: []string{"Agricultural_1"}, Relations: map[string]float64{}},
	}
}
